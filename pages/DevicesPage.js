...
var DevicesPage = (function () {
    function DevicesPage() {
        ...
        this.deviceTypeOptionTablet = element(By.xpath("//option[7]"));
        this.deviceTypeOptionSmartTV = element(By.xpath("//option[5]"));
        this.deviceTypeOptionComputer = element(By.xpath("//option[6]"));
        this.deviceTypeOptionConsole = element(By.xpath("//option[3]"));
        this.deviceTypeOptionVR = element(By.xpath("//option[4]"));

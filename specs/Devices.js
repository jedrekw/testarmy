...
var EC = protractor.ExpectedConditions;
    ...
    describe('Devices', function() {
        ...
        it('- add smartphone should succeed', function(){
            ...
            browser.driver.wait(EC.presenceOf(devices.addDeviceButton), 10000);
            devices.removeAllDevices();
            devices.addDevice();
            browser.driver.wait(EC.presenceOf(devices.deviceTypeDropdown), 10000);
            ...
            browser.driver.sleep(1000);
            var source1 = browser.driver.getPageSource();
